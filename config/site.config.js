...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'mednight4@email.ncu.edu.cn',

  // [OPTIONAL] This is the website icon to the left of the title inside the navigation bar. It should be placed under the
  // /public directory of your GitHub project (not your OneDrive folder!), and referenced here by its relative path to /public.
  icon: 'https://mednight4.oss-cn-shenzhen.aliyuncs.com/typecho/static/favicon-32x32-next.png',

  // The name of your website. Present alongside your icon.
  title: "mednight4's netdisk",
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://mednight4.com',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/mednight4',
    },
  ],
